            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        console.log(Worker.serverInfo.imap.auth);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        mailbox = _a.sent();
                        console.log("IMAP.Worker.listMessages(): Message count = ".concat(mailbox.exists));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        _a.sent();
                        return [2 /*return*/, parsed.text == undefined ? 'No message found' : parsed.text];
                }
            });
        });
    }; /* End getMessageBody(). */
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        client = _a.sent();
                        return [4 /*yield*/, client.deleteMessages(inCallOptions.mailbox, inCallOptions.id, {
                                byUid: true,
                            })];
                    case 2:
                        _a.sent();
